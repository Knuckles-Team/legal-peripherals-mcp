...
@pytest.mark.concept("LP-OS.governance.legal")
def test_api_client_basic_mock(mock_ctx):
    """CONCEPT:LP-OS.governance.legal Test basic mock initialization of client facade."""
...
def test_api_client_endpoints(mock_ctx):
    """CONCEPT:LP-OS.governance.legal Verify endpoint configuration on dynamic client."""
